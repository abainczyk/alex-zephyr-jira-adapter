...
import ConnectWithJiraStep from './components/views/setup-view/ConnectWithJiraStep';
import ConnectWithAlexStep from './components/views/setup-view/ConnectWithAlexStep';
...
Vue.component(ConnectWithJiraStep.name, ConnectWithJiraStep);
Vue.component(ConnectWithAlexStep.name, ConnectWithAlexStep);
...
Vue.component(ProjectEventList.name, ProjectEventList);
